...
import (
	...
	"github.com/Miniplays-Tickets/dashboard/app/http/endpoints/api"
	"github.com/Miniplays-Tickets/dashboard/app/http/endpoints/api/admin/botstaff"
	api_blacklist "github.com/Miniplays-Tickets/dashboard/app/http/endpoints/api/blacklist"
	api_import "github.com/Miniplays-Tickets/dashboard/app/http/endpoints/api/export"
	api_forms "github.com/Miniplays-Tickets/dashboard/app/http/endpoints/api/forms"
	api_integrations "github.com/Miniplays-Tickets/dashboard/app/http/endpoints/api/integrations"
	api_panels "github.com/Miniplays-Tickets/dashboard/app/http/endpoints/api/panel"
	api_premium "github.com/Miniplays-Tickets/dashboard/app/http/endpoints/api/premium"
	api_settings "github.com/Miniplays-Tickets/dashboard/app/http/endpoints/api/settings"
	api_override "github.com/Miniplays-Tickets/dashboard/app/http/endpoints/api/staffoverride"
	api_tags "github.com/Miniplays-Tickets/dashboard/app/http/endpoints/api/tags"
	api_team "github.com/Miniplays-Tickets/dashboard/app/http/endpoints/api/team"
	api_ticket "github.com/Miniplays-Tickets/dashboard/app/http/endpoints/api/ticket"
	"github.com/Miniplays-Tickets/dashboard/app/http/endpoints/api/ticket/livechat"
	api_transcripts "github.com/Miniplays-Tickets/dashboard/app/http/endpoints/api/transcripts"
	api_whitelabel "github.com/Miniplays-Tickets/dashboard/app/http/endpoints/api/whitelabel"
	"github.com/Miniplays-Tickets/dashboard/app/http/endpoints/root"
	"github.com/Miniplays-Tickets/dashboard/app/http/middleware"
...
func StartServer(logger *zap.Logger, sm *livechat.SocketManager) {
	...
	userGroupAdmin := apiGroup.Group("/user", middleware.AuthenticateToken, middleware.UpdateLastSeen, middleware.AuthenticateGuild(permission.Admin))
